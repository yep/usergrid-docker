...
echo "+++ usergrid configuration:  CASSANDRA_CLUSTER_NAME=${CASSANDRA_CLUSTER_NAME}  USERGRID_CLUSTER_NAME=${USERGRID_CLUSTER_NAME}  ADMIN_USER=${ADMIN_USER}  ORG_NAME=${ORG_NAME}  TOMCAT_RAM=${TOMCAT_RAM}  APP_NAME=${APP_NAME}"
